...
namespace ComputerInterface.Views.GameSettings
{
    public class NameSettingView : ComputerView
    {
        ...
        private void Redraw()
        {
            ...
            /* dunno if you would want this
            if (!_textInputHandler.Text.IsNullOrWhiteSpace() && !GorillaNetworking.GorillaComputer.instance.CheckAutoBanListForName(_textInputHandler.Text))
            {
                str.BeginColor("7F0000").AppendLines(2);
                str.Append("* This name was blacklisted by the name filter.").EndColor();
            }
